  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.devs}>
        ...
        <FlipCard email="francisco.maldona.pb@compasso.com.br" devImg={Francisco} icon={BackEnd} developed="Back End" name="Francisco G. Maldonado" education="Systems Analysis and Development" company="IFSP - Federal Institute of São Paulo" role="Student" age="21" location="São Carlos - SP - Brazil" linkedin="www.linkedin.com/in/francisco-guatura-maldonado-290402209" github="https://github.com/FranciscoGMaldonado" />
